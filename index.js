...
const items = ["Insert splash text here", "HTML is a programming language", "C++ > Rust", "Oh hey there", "Hyperdash will come before 2.2", "2.2 when?", "Now with Invis List!", "Now with Challenges!", "Automatically copying IDs since 2020", "Also try Geometry Dash", "Hi Matcool", "F in chat", "Hi YT", "🅱️", "This text is random", "GG EZ"]
